...
class Place(BaseModel, Base):
    ...
    # Define columns based on storage type (database or not)
    city_id = Column(
    ...
    # Define relationship for reviews based on storage type
    ...
    # Define relationship for amenities based on storage type
