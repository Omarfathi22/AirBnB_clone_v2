...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        """Instantiates a new model with optional attributes"""
        if not kwargs:
            # Generate new UUID for id and set timestamps
            ...
            # Ensure id, created_at, and updated_at are set if not provided
